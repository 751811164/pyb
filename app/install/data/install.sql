...
CREATE TABLE `ob_action_log` (
  ...
  `admin_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '执行会员id',
...
CREATE TABLE `ob_admin` (
  ...
  `is_share_admin` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否共享会员',
...
INSERT INTO `ob_menu` VALUES ('16', '会员管理', '0', '3', 'admin', 'admin/index', '0', 'fa-users', '1', '1520506753', '0');
INSERT INTO `ob_menu` VALUES ('17', '会员列表', '16', '1', 'admin', 'admin/adminlist', '0', 'fa-list', '1', '1495272875', '0');
INSERT INTO `ob_menu` VALUES ('18', '会员添加', '16', '2', 'admin', 'admin/adminadd', '0', 'fa-user-plus', '1', '1520505510', '0');
...
INSERT INTO `ob_menu` VALUES ('36', '会员授权', '27', '0', 'admin', 'auth_manager/adminaccess', '1', '', '1', '0', '0');
...
INSERT INTO `ob_menu` VALUES ('134', '授权', '17', '0', 'admin', 'admin/adminauth', '1', '', '1', '1492238568', '1492101426');
...
INSERT INTO `ob_menu` VALUES ('199', '权限等级', '198', '0', 'admin', 'statistic/admintree', '0', 'fa-users', '1', '1512638868', '1512638868');
...
INSERT INTO `ob_menu` VALUES ('202', '会员增长', '198', '0', 'admin', 'statistic/admingrowth', '0', 'fa-line-chart', '1', '1512801997', '1512801997');
